...
gradle :pf4j:plugin-spring:buildPlugin
...
cp plugin-spring/build/libs/plugin-spring-0.1.zip pf4j-test/lib/
...
cp plugin-spring/build/libs/plugin-spring-0.1.zip pf4j-spring/lib/
